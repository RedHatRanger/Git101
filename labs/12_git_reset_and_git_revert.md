...
**Now**, in **Lab 12**, we’ll learn how to **undo** changes using **git reset** and **git revert**. Sometimes you make a mistake, or want to travel back in time to fix something—\$1## Lab Setup
...
> **Kid-Friendly**: This is like reading the pages in Sarah’s last update to see how many story titles she touched.
...
> **Kid-Friendly**: You’re not erasing the old page, you’re adding a page on top that says, “Ignore the previous page!”
