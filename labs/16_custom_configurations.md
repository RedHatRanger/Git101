...
- **Lab 2**: We branched our code to test new stories.
...
- **Lab 10**: Rebased commits for a tidy timeline.
- **Lab 11**: Cherry-picked a single commit.
- **Lab 12**: Reset or reverted mistakes.
- **Lab 13**: Stashed changes to save them for later.
- **Lab 14**: We used Reflog to recover "lost" commits.
- **Lab 15**: Peeked under Git’s hood with plumbing commands.
...
3. **Set up a global **`` (always ignore certain files).
